...
router.route("/search").get(searchCourse); //search for courses - public route
router.route("/published-courses").get(getPublishCourse); //get all published courses - public route
...
router.route("/:courseId").get(getCourseById); //get a course by id
