...
const Profile = () => {
  ...
  const updateUserHandler = async () => {
    ...
    formData.append("name", name || user.name); // Fallback to current name
    if (profilePhoto) {
    ...
    <div className="max-w-4xl mx-auto px-4 my-10 mt-20">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8 my-5">
        <div className="flex flex-col items-center">
          <Avatar className="h-24 w-24 md:h-32 md:w-32 mb-4 relative aspect-square">
            <AvatarImage
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 my-5">
          {user?.enrolledCourses.length === 0 ? (
            <h1>You haven't enrolled any courses yet!</h1>
          ) : (
